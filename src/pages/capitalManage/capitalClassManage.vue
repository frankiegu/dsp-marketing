<template>
  <div class="sms-template-container">
        ...
        <div class="search-container">
          <el-row :gutter="15">
            <el-col :span="5" :offset="15">
              <el-input :span="5" v-model="searchData.key" @keyup.native.enter="searchEvent"  placeholder="请输入操作类名"></el-input>
            </el-col>
            <el-col :span="2">
    ...
    <el-dialog :title='isEdit?"新增操作类":"编辑操作类"'  :visible.sync="dialogFormVisible">
      <el-form :model="addSmsTemplate" :rules="rules" ref="addSmsTemplate">
        ...
        <el-form-item label="操作类" :label-width="formLabelWidth" prop="classpath">
          <el-input placeholder="请输入操作类" v-model="addSmsTemplate.classpath" ></el-input>
        </el-form-item>
      </el-form>
...
<script>
  import { capitalClassList,capitalClassAddOrModify,capitalClassDelete } from '@/api/capital-api';
      ...
      handleStop(index, row){
        ...
        if(row.status){
          this.$confirm('此操作将禁用【' + row.name + '】渠道, 是否继续?', '提示', {
            ...
            capitalClassDelete(data).then(function (res) {
              _self.$message({
                type: 'success',
                message: '禁用成功!'
              });
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            if(_self.isEdit){
              ...
              capitalClassAddOrModify(data).then(function(res){
              ...
              capitalClassAddOrModify(data).then(function(res){
                ...
                _self.loading2 = true;
                capitalClassList(JSON.stringify(data)).then(function (res) {
                  _self.loading2 = false;
                  _self.tableData = res.data;
                  _self.page = {

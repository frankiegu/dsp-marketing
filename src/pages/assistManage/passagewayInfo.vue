  ...
  <div class="passageway-info-container" style="background-color: #fff">
      ...
      <el-col>
        ...
        <div class="search-container">
          <el-row :gutter="15">
            <el-col :span="5" :offset="15">
              <el-input :span="5" v-model="searchData.industId" @keyup.native.enter="searchEvent"  placeholder="请输入行业ID"></el-input>
            </el-col>
            <el-col :span="2">
        ...
        <div class="search-table">
          <el-table
            ...
            <el-table-column prop="cityId" label="城市ID" width="100" show-overflow-tooltip> </el-table-column>
            <el-table-column prop="cityName" label="城市名称" show-overflow-tooltip> </el-table-column>
    ...
    <el-dialog :title='isEdit?"新增":"编辑"'  :visible.sync="dialogFormVisible">
      <el-form :model="addSmsTemplate" ref="addSmsTemplate">
        ...
        <el-form-item label="选择通道" :label-width="formLabelWidth">
          <el-tooltip class="item" effect="dark" :content="addSmsTemplate.templateContent" placement="top" :disabled="addSmsTemplate.templateContent?false:true">
            <el-button  style="width:100%" @click="selectTemplate">{{addSmsTemplate.templateId?addSmsTemplate.templateId+'：'+addSmsTemplate.templateName:'请选择通道'}}</el-button>
          </el-tooltip>
        </el-form-item>
      </el-form>
    ...
    <el-dialog :title="'添加参数'"  :visible.sync="addDialogParamVisible">
      <el-row style="margin-bottom: 15px;">
        <el-col :span="12" :offset="4">
          <el-input placeholder="请输入通道名称" v-model="searchParamItemData"></el-input>
        </el-col>
        <el-col :span="8">
...
<script>
  ...
  import { ccRelationList , ccRelationAddOrModify , ccRelationDelete , orgIndustryList ,orgCityView ,cityGet} from '@/api/assist-api';
  ...
  export default {
    ...
    methods: {
      ...
      handleCurrentChangeParam2(val){
        let _self = this;
        let data = {"insCode":_self.searchData.insCode,"insName":_self.searchParamItemData2,"orgId":_self.orgId,"status":1,"uId": "admin",user:this.account, "currPage": val, "prePageResult": 12};
      ...
      selectTemplate2(){
        ...
        let dataParam = {"insCode":_self.searchData.insCode,"insName":_self.searchParamItemData2,"orgId":_self.orgId,"status":1,"uId": "admin","user":_self.account, "currPage": 1, "prePageResult": 12};
      ...
      addParamItem2(index,formName,ev){
        let _self = this;
        this.addSmsTemplate.industId = _self.smsParamsList2[index].id;
      ...
      addParamItem(index,formName,ev){
        ...
        this.addSmsTemplate.templateName = _self.smsParamsList[index].name;
        this.addSmsTemplate.templateContent = _self.smsParamsList[index].remark;
      ...
      searchEvent(){
        ...
        let data = {"industId":_self.searchData.industId,"uId": "admin",user:this.account, "pageIndex": 1, "pageSize": 10};
        _self.loading2 = true;
        ccRelationList(data).then(function (res) {
      ...
      handleEdit(formName, index, row) {
        ...
        this.addSmsTemplate.templateId = this.tableData[index].channelId;
        this.addSmsTemplate.templateName = this.tableData[index].channelName;
      ...
      handleStop(index, row){
        ...
        if(row.status){
          this.$confirm('此操作将禁用【' + row.id + '】, 是否继续?', '提示', {
            ...
            ccRelationDelete(data).then(function (res) {
              _self.$message({
                type: 'success',
                message: '禁用成功!'
              });
          ...
          if (valid) {
            ...
            if(_self.isEdit){
              let data = {
                ...
                channelName:_self.addSmsTemplate.templateName,
                channelId:_self.addSmsTemplate.templateId,
                cityId: _self.addEditDialogForm.areaId,
                cityName: _self.addEditDialogForm.areaName,
                user:this.account,
                uId:"admin"//此处写死 admin
              };
              ccRelationAddOrModify(data).then(function(res){
              ...
              ccRelationAddOrModify(data).then(function(res){
                ...
                let data = {"industId":_self.searchData.industId,"uId": "admin",user:_self.account, "pageIndex": 1, "pageSize": _self.page.pageSize};
                _self.loading2 = true;
                ccRelationList(JSON.stringify(data)).then(function (res) {
                  _self.loading2 = false;
                  _self.tableData = res.data;
                  _self.page = {
      ...
      handleSizeChange(val) {
        ...
        let _self = this;
        let key = this.searchData.key;
        let data = {"industId":_self.searchData.industId,"uId": "admin",user:this.account, "pageIndex": 1, "pageSize": val};
        _self.loading2 = true;
        ccRelationList(JSON.stringify(data)).then(function (res) {
          _self.loading2 = false;
          _self.tableData = res.data;
      ...
      handleCurrentChange(val) {
        ...
        let _self = this;
        let key = this.searchData.key;
        let data = {"industId":_self.searchData.industId,"uId": "admin",user:this.account, "pageIndex": val, "pageSize": this.page.pageSize};
        _self.loading2 = true;
        ccRelationList(JSON.stringify(data)).then(function (res) {
          _self.loading2 = false;
          _self.tableData = res.data;
    ...
    created() {
      ...
      orgCityView({orgCode:this.orgCode}).then((res)=>{

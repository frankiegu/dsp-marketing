      ...
      <el-col>
        <div class="search-container">
          <el-row :gutter="15">
            ...
            <el-col :span="5">
              <el-input :span="5" v-model="searchData.code"  placeholder="请输入行业编码"></el-input>
            </el-col>
            <el-col :span="5">
              <el-input :span="5" v-model="searchData.interval"  placeholder="请输入小时"></el-input>
            </el-col>
            <el-col :span="5">
        ...
        <div class="search-table">
          <el-table
            ...
            <el-table-column prop="code" label="行业编码"  show-overflow-tooltip> </el-table-column>
            <el-table-column prop="interval" label="小时"  show-overflow-tooltip> </el-table-column>
    ...
    <el-dialog :title='isEdit?"编辑":"新增"' :visible.sync="dialogFormVisible">
      <el-form ref="editDialogForm" :model="addEditDialogForm" class="fSelect">
        ...
        <el-form-item label="名称" prop="name" :label-width="formLabelWidth">
          <el-input v-model="addEditDialogForm.name"></el-input>
        </el-form-item>
        <el-form-item label="选择行业" :label-width="formLabelWidth">
          <el-button style="width:100%" @click="selectTemplate2">{{addSmsTemplate.code?addSmsTemplate.code+'：'+addSmsTemplate.industName:'请选择行业'}}</el-button>
        </el-form-item>
        <el-form-item label="小时" prop="dayInterval" :label-width="formLabelWidth">
          <el-input v-model="addEditDialogForm.interval"></el-input>
        </el-form-item>
...
<script>
  ...
  import { lPeriodList , lPeriodDelete , lPeriodRevoke  , lPeriodSave ,orgIndustryList } from '@/api/assist-api'
  ...
  export default {
    ...
    methods: {
      ...
      addParamItem2(index,formName,ev){
        ...
        this.addSmsTemplate.code = _self.smsParamsList2[index].insCode;
      ...
      submitForm(formName){
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            if(_self.isEdit){
              let data = {"id":_self.tableData[_self.Editindex].id,"orgCode":_self.orgCode,"name":_self.addEditDialogForm.name,"interval":_self.addEditDialogForm.interval	,"code":_self.addSmsTemplate.code	};
              lPeriodSave(data).then(function (res) {
                _self.$message({
                  type: 'success',
                  message: '编辑成功!'
                });
                _self.tableData[_self.Editindex].interval = _self.addEditDialogForm.interval;
                _self.tableData[_self.Editindex].name = _self.addEditDialogForm.name;
                _self.tableData[_self.Editindex].code = _self.addSmsTemplate.code;
              ...
              let data = {"name":_self.addEditDialogForm.name,"orgCode":_self.orgCode,"interval":_self.addEditDialogForm.interval	,"code":_self.addSmsTemplate.code	};
              lPeriodSave(data).then(function (res) {
                _self.$message({
                  type: 'success',
                  message: '新增成功!'
                ...
                _self.loading2 = true;
                let data = {"name":_self.searchData.name,"orgCode":_self.orgCode,"code":_self.searchData.code,"interval":_self.searchData.interval,"status":_self.searchData.status,"currPage":1,"prePageResult":_self.page.pageSize};
                lPeriodList(data).then(function (res) {
      ...
      handleEdit(name,index,row){
        ...
        _self.addEditDialogForm.interval =_self.tableData[index].interval;
        _self.addSmsTemplate.code =_self.tableData[index].code;
      ...
      handleStop(index,row){
        ...
        if(_self.tableData[index].status===1){
          this.$confirm('此操作将禁用【' + row.code + '】, 是否继续?', '提示', {
            confirmButtonText: '确定',
            cancelButtonText: '取消',
            type: 'warning'
          }).then(() => {
            lPeriodDelete(data).then(function(res){
              if (res.success) {
                _self.$message({
                  type: 'success',
                  message: '禁用成功!'
          ...
          this.$confirm('此操作将激活【' + row.code + '】, 是否继续?', '提示', {
            confirmButtonText: '确定',
            cancelButtonText: '取消',
            type: 'warning'
          }).then(() => {
            lPeriodRevoke(data).then(function(res){
              _self.$message({
                type: 'success',
                message: '激活成功!'
              });
      ...
      searchEvent(){
        let _self = this;
        _self.loading2 = true;
        let data = {"name":_self.searchData.name,"orgCode":_self.orgCode,"code":_self.searchData.code,"interval":_self.searchData.interval,"status":_self.searchData.status,"currPage":_self.page.currentPage,"prePageResult":_self.page.pageSize};
        lPeriodList(data).then(function (res) {
          _self.loading2 = false;
          _self.tableData = res.data;
          _self.page={
      ...
      handleSizeChange(val){
        let _self = this;
        _self.loading2 = true;
        let data = {"name":_self.searchData.name,"orgCode":_self.orgCode,"code":_self.searchData.code,"interval":_self.searchData.interval,"status":_self.searchData.status,"currPage":_self.page.currentPage,"prePageResult":val};
        lPeriodList(data).then(function (res) {
          _self.loading2 = false;
          _self.tableData = res.data;
          _self.page={
      ...
      handleCurrentChange(val){
        let _self = this;
        _self.loading2 = true;
        let data = {"name":_self.searchData.name,"orgCode":_self.orgCode,"code":_self.searchData.code,"interval":_self.searchData.interval,"status":_self.searchData.status,"currPage":val,"prePageResult":_self.page.pageSize};
        lPeriodList(data).then(function (res) {
          _self.loading2 = false;
          _self.tableData = res.data;
          _self.page={
    ...
    created() {
      let _self = this;
      _self.loading2 = true;
      let data = {"name":_self.searchData.name,"orgCode":_self.orgCode,"code":_self.searchData.code,"interval":_self.searchData.interval,"status":_self.searchData.status,"currPage":1,"prePageResult":10};
      lPeriodList(data).then(function (res) {
        _self.loading2 = false;
        _self.tableData = res.data;
        _self.page={

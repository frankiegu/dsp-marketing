      ...
      <el-row>
        <el-col>
          <div class="search-container">
            ...
            <el-input class="search-key" v-model="searchData.channel" :maxlength="30" placeholder="请输入渠道编码"></el-input>
            <el-date-picker
              class="search-key"
            ...
            <el-table
              ...
              <el-table-column prop="jobNo" label="任务编号" show-overflow-tooltip width="120">
                <template slot-scope="scope">
                  <router-link :to="'/home/smsPreparation?jobNo='+scope.row.jobNo">{{scope.row.jobNo}}</router-link>
                </template>
              </el-table-column>
              ...
              <el-table-column label="操作" width="420">
                <template slot-scope="scope">
                  ...
                  <el-button
                    ...
                    @click="outsideSend(scope.row.id,scope.row.status)">外部发送</el-button>
                  <el-button
                    size="small"
...
<script>
  ...
  export default {
    ...
    methods: {
      outsideSend(id){
        window.location.href = window.location.origin + '/dspSms/send/handMove'+"?recordId="+id+"&Authorization="+sessionStorage.getItem("userToken");
      },
      handleCheck(id){
          this.checkCurId = id;
      },
